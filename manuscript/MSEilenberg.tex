...
\providecommand{\lean}[1]{\par\noindent\parbox{\linewidth}{\raggedright\footnotesize\texttt{#1}}\par} % blueprint: Lean declaration name (inline pointer)
...
\lean{\detokenize{Mslang.iProd}, \detokenize{Mslang.iProj}, \detokenize{Mslang.iPair}}
\blockid{B-D003}
\begin{definition}
...
\lean{\detokenize{Mslang.SortedIso}, \detokenize{Mslang.iCoprod}, \detokenize{Mslang.deltaT}, \detokenize{Mslang.sigmaPUnitEquiv}, \detokenize{Mslang.deltaEquiv}, \detokenize{Mslang.delta_iso_coprod}}
\blockid{B-R001}
\begin{remark}
...
\lean{\detokenize{Mslang.Sub_iInter}, \detokenize{Mslang.IsClosureSystem}}
\blockid{B-D010}
\begin{definition}
...
\lean{\detokenize{Mslang.Sub_iUnion}, \detokenize{Mslang.IsAlgebraicClosureSystem}}
\blockid{B-D012}
\begin{definition}
Let $A$ be an $S$-sorted set.
\begin{enumerate}
...
\lean{\detokenize{Mslang.SortedEqv}, \detokenize{Mslang.sat}, \detokenize{Mslang.IsSat}}
\blockid{B-D014}
\begin{definition}
...
\lean{\detokenize{Mslang.quot}, \detokenize{Mslang.supp_quot}}
\blockid{B-R005}
\begin{remark}
...
\lean{\detokenize{Mslang.satSets}, \detokenize{Mslang.satSets_antitone}}
\blockid{B-R007}
\begin{remark}
...
\lean{\detokenize{Mslang.SortedMap}, \detokenize{Mslang.ker}}
\blockid{B-D015}
\begin{definition}
...
\lean{\detokenize{Mslang.MemSg}, \detokenize{Mslang.Sg}, \detokenize{Mslang.IsGenerating}, \detokenize{Mslang.subset_Sg}, \detokenize{Mslang.Sg_isSubalgebra}, \detokenize{Mslang.Sg_least}, \detokenize{Mslang.Sg_monotone}, \detokenize{Mslang.Sg_idem}, \detokenize{Mslang.Sg_isClosureOperator}}
\blockid{B-D021}
\begin{definition}
...
\lean{\detokenize{Mslang.IsCongruence}}
\blockid{B-D024}
\begin{definition}
...
\lean{\detokenize{Mslang.deltaEqv}, \detokenize{Mslang.deltaEqv_eq_iInf_congCogenerated}}
\blockid{B-R020}
\begin{remark}
...
%\bibitem%[mb72]
%{mb72}
%M. Barr, \emph{The point of the empty set}. (French summary) Cahiers Topologie Géom. Différentielle \textbf{13} (1972), pp. 357--368
...
\bibitem%[Grt11]
{gG11}
G. Grätzer, \emph{Lattice theory: foundation}, Birkhäuser/Springer Basel AG, Basel, 2011.
