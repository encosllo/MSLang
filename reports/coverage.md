...
|---|---|---|---|---|---|---|---|
| `B-C001` | corollary | Preliminaries. | pass | pass | pass | none | D1; D2; D4 |
| `B-C002` | corollary | Preliminaries. | none | pass | pass | none | D1; D2; D4 |
| `B-D006` | definition | Preliminaries. | none | none | pass | none | D1; D2; D4 |
| `B-P002` | proposition | Preliminaries. | none | pass | pass | none | D1; D2; D4 |
| `B-P003` | proposition | Preliminaries. | none | pass | pass | none | D1; D2; D4 |
| `representation/encoding` | - | - | none | none | none | pass | - |

123 block(s) have no evidence.
