...
| `Mslang/Regular.lean` | the second Eilenberg theorem layer: finite-index congruences (`B-D040`, `B-D041`), finite algebras (`B-D042`, `B-D043`), regular languages (`B-D044`), `Cgr_fi(A)` as a filter (`B-P031`), and `Form_Alg_f(Σ) ≃o Form_Cgr_fi(Σ)` (`B-P034`) |
