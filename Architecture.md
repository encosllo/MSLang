...
| `Mslang/Formation.lean` | monomorphisms/epimorphisms and subdirect products (`B-D028`), formations of congruences (`B-D030`) and of algebras (`B-D032`, `B-D033`), `Form_Alg(Σ)` as an algebraic closure system (`B-P018`), `𝔉_F` (`B-P019`) and `F_𝔉` (`B-P015`), and the `B-P020` round trips |
